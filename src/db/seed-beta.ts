...
const ROOMS: RoomConfig[] = [
  {
    ...
    height: 10,
    furniture: [
      { item: 'sofa_modern', x: 2, y: 2, rotation: 90 },
      { item: 'sofa_modern', x: 7, y: 2, rotation: 90 },
      { item: 'table_coffee', x: 4, y: 4, rotation: 0 },
      { item: 'table_coffee', x: 5, y: 4, rotation: 0 },
      { item: 'plant_large', x: 1, y: 1, rotation: 0 },
      { item: 'plant_large', x: 8, y: 1, rotation: 0 },
      { item: 'lamp_floor', x: 2, y: 7, rotation: 0 },
      { item: 'lamp_floor', x: 7, y: 7, rotation: 0 },
      { item: 'rug_large', x: 4, y: 5, rotation: 0 },
      { item: 'reception_desk', x: 5, y: 8, rotation: 180 },
    ],
  },
  {
    name: 'Trading Floor',
    ...
    height: 8,
    furniture: [
      { item: 'table_conference', x: 3, y: 3, rotation: 0 },
      { item: 'chair_office', x: 2, y: 3, rotation: 90 },
      { item: 'chair_office', x: 4, y: 3, rotation: 270 },
      { item: 'chair_office', x: 3, y: 2, rotation: 0 },
      { item: 'chair_office', x: 3, y: 4, rotation: 180 },
      { item: 'whiteboard', x: 1, y: 1, rotation: 0 },
      { item: 'safe', x: 6, y: 6, rotation: 0 },
      { item: 'computer', x: 6, y: 2, rotation: 270 },
      { item: 'plant_potted', x: 1, y: 6, rotation: 0 },
    ],
  },
  {
    name: 'The Garden',
    ...
    height: 8,
    furniture: [
      { item: 'tree', x: 2, y: 2, rotation: 0 },
      { item: 'tree', x: 9, y: 2, rotation: 0 },
      { item: 'bench_park', x: 5, y: 3, rotation: 180 },
      { item: 'bench_park', x: 6, y: 3, rotation: 180 },
      { item: 'fountain', x: 5, y: 5, rotation: 0 },
      { item: 'plant_potted', x: 3, y: 4, rotation: 0 },
      { item: 'plant_potted', x: 8, y: 4, rotation: 0 },
      { item: 'plant_potted', x: 3, y: 6, rotation: 0 },
      { item: 'plant_potted', x: 8, y: 6, rotation: 0 },
      { item: 'flowers', x: 1, y: 5, rotation: 0 },
      { item: 'flowers', x: 10, y: 5, rotation: 0 },
      { item: 'lamp_garden', x: 4, y: 1, rotation: 0 },
      { item: 'lamp_garden', x: 7, y: 1, rotation: 0 },
    ],
  },
  {
    name: 'Arcade',
    ...
    height: 8,
    furniture: [
      { item: 'arcade_machine', x: 1, y: 2, rotation: 90 },
      { item: 'arcade_machine', x: 1, y: 4, rotation: 90 },
      { item: 'arcade_machine', x: 1, y: 6, rotation: 90 },
      { item: 'pinball_machine', x: 6, y: 2, rotation: 270 },
      { item: 'pinball_machine', x: 6, y: 5, rotation: 270 },
      { item: 'chair_gaming', x: 3, y: 3, rotation: 0 },
      { item: 'chair_gaming', x: 4, y: 3, rotation: 0 },
      { item: 'table_small', x: 3, y: 6, rotation: 0 },
      { item: 'speaker', x: 2, y: 1, rotation: 0 },
      { item: 'speaker', x: 5, y: 1, rotation: 0 },
      { item: 'neon_sign', x: 4, y: 7, rotation: 180 },
    ],
  },
  {
    name: 'Library',
    ...
    height: 8,
    furniture: [
      { item: 'bookshelf', x: 1, y: 2, rotation: 90 },
      { item: 'bookshelf', x: 1, y: 4, rotation: 90 },
      { item: 'bookshelf', x: 1, y: 6, rotation: 90 },
      { item: 'bookshelf', x: 4, y: 2, rotation: 270 },
      { item: 'bookshelf', x: 4, y: 4, rotation: 270 },
      { item: 'bookshelf', x: 4, y: 6, rotation: 270 },
      { item: 'chair_reading', x: 2, y: 3, rotation: 0 },
      { item: 'chair_reading', x: 3, y: 3, rotation: 180 },
      { item: 'lamp_desk', x: 2, y: 2, rotation: 0 },
      { item: 'lamp_desk', x: 3, y: 2, rotation: 0 },
      { item: 'rug_small', x: 2, y: 5, rotation: 0 },
      { item: 'globe', x: 2, y: 6, rotation: 0 },
    ],
  },
];
